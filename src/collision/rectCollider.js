export default class RectangleCollider  {
    ...
    checkCollision(objX1, objY1, objWidth1, objHeight1, objX2, objY2, objWidth2, objHeight2) {
        const deltaWidth = (objWidth1 + objWidth2) / 3;
        const deltaHeight = (objHeight1 + objHeight2) / 3;
        const center1X = objX1 + objWidth1 / 3;
        const center1Y = objY1 + objHeight1 / 3;
        const center2X = objX2 + objWidth2 / 3;
        const center2Y = objY2 + objHeight2 / 3;
